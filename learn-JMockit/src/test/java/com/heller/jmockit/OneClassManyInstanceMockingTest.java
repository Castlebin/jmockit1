...
public class OneClassManyInstanceMockingTest {
    ...
    public void testMocking1() {
        HelloJMockit instance1 = new HelloJMockit();
        HelloJMockit instance2 = new HelloJMockit();
        
        // 直接把要Mock的实例传递给Expectations的构造函数即可Mock这些实例
        ...
        HelloJMockit instance3 = new HelloJMockit();
        // instance1的ordinaryMethod()方法被Mock了
        Assert.assertTrue(instance1.ordinaryMethod() == 20);
        // instance2的ordinaryMethod()方法被Mock了
    ...
    // Mock方法三: 用@Injectable。适用场景： 不是类的所实例都需要Mock，不同实例也能保留不同的Mock逻辑
    @Test
